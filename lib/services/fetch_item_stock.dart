...
Future<List<mi.ItemStock>> fetchModelItemStock(
  ...
  for (var i=0; i < mapResponse['SdtItemStock'].length; i++){
    itemStockModel = mi.ItemStock(mapResponse['SdtItemStock'][i]['color'],
...
//  Dummy data
  if (itemStockModel == null) {
    itemStockModel = mi.ItemStock('Blue', '', '', '');
    itemStockModel = mi.ItemStock('', 'Small', '8', '4');
    itemStockModel = mi.ItemStock('', 'Medium', '2', '0');
    itemStockModel = mi.ItemStock('', 'Large', '5', '3');
    itemStockModel = mi.ItemStock('Total Blue', '', '15', '7');
  }
